...
@implementation DVPieChartTeacher
...
//    centerView.frame = CGRectMake(0, 0, 195, 195);
    ...
    //添加一些label属性------------------------------------------*********
    centerView.nameLabel.numberOfLines = 0;
    centerView.nameLabel.font = [UIFont boldSystemFontOfSize:30];
