...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (self.isCePing) {
        ...
        [ZiCeData navigationController:self.navigationController tableView:tableView didSelectRowAtIndexPath:indexPath];
    }
}
...
- (void)alertShow {
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:nil message:@"是否保存本次测评结果" preferredStyle:UIAlertControllerStyleAlert];
